...
|-------------------|--------------|----------|---------|----------|---------|-------------------------------------
|id	                | int8	       | 64       |	    Y	|   Y      | ID      |                                      |
|job_no	            | varchar	   | 32		  |     N   |   Y      | 人员账号 | 唯一约束                              |
|name	            | varchar      | 20       |     N   |   Y      | 人员姓名 |                                      |
|mobile             | varchar	   | 11		  |     N   |   Y      | 手机     |                                      |
|password           | varchar      | 64       |     N   |   Y      | 密码     |                                      |
|salt	            | varchar      | 32       |     N   |   Y      | 盐       |                                      |
|status             | varchar      | 20       |     N   |   Y      | 状态     | dimission("离职"), inservice("在职")  |
|remark             | text         |          |     N   |   N      | 备注     |                                      |
|version            | int4         | 32       |     N   |   Y      | 版本号   | 乐观锁                                |
|create_date        | timestamp    | 6        |     N   |   Y      | 创建时间  |                                     |
